...
namespace Labels
{
    public partial class LargeFormat : Form
    {
        int noPages = 0;
        int totalPages = 1;
        List<int> upperLower;
        ...
        public LargeFormat(int totalPages, List<int> upperLower)
        {
            InitializeComponent();
        ...
        public LargeFormat(int totalPages, List<int> upperLower, List<string> values)
        {
            InitializeComponent();
            this.totalPages = totalPages;
            this.upperLower = upperLower;
        ...
        private void changeBarcodeLabelValues(List<string> values, int index)
        {
            ...
            string prefix = GlobalV.LFPrefix;
        ...
        private void LargeFormat_Load(object sender, EventArgs e)
        {
            //btnPrint.PerformClick();
        }

        private void LargeFormat_Shown(object sender, EventArgs e)
        {
            btnPrint.PerformClick();
        }
    }
